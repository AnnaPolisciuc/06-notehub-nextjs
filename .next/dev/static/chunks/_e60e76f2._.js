...
function NoteDetails({ id }) {
    ...
    const { data: note, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "NoteDetails.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNoteById"])(id)
        }["NoteDetails.useQuery"]
    });
...
_s(NoteDetails, "sOKjnddqQC2pblvUX7f0LJ3Ma4U=", false, function() {
    return [
...
//# sourceMappingURL=_e60e76f2._.js.map